...
namespace Nez.Tweens
{
	...
	public static class Lerps
	{
	    ...
	    public static Vector2 lerpDamp(Vector2 source, Vector2 target, float smoothing)
	    {
	        return new Vector2(lerpDamp(source.X, target.X, smoothing), lerpDamp(source.Y, target.Y, smoothing));
	    }
